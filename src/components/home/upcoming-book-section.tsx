...
export function UpcomingBookSection({ book }: UpcomingBookSectionProps) {
  return (
    <section className="w-full flex-1 bg-[color:var(--primary)]/12 px-4 py-12 sm:px-10">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <Link
          href="/books"
          className="mt-5 inline-flex bg-[color:var(--primary)] px-5 py-2.5 text-sm font-semibold text-[color:var(--text)] transition-colors hover:brightness-110"
        >
          View bibliography
        </Link>
      </div>
