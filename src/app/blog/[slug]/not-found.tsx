...
export default function BlogPostNotFound() {
  return (
    <main className="mx-auto w-full max-w-3xl space-y-5 px-4 py-12 sm:px-6">
      ...
      <Link
        href="/blog"
        className="inline-flex rounded-full border border-[color:var(--neutral)]/45 px-4 py-2 text-sm font-semibold text-[color:var(--primary)] transition-colors hover:bg-[color:var(--primary)]/10"
      >
        Return to blog
      </Link>
    </main>
